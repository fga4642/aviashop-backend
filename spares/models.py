...
class Spare(models.Model):
    ...
    price = models.IntegerField(default=1000, verbose_name="Цена", blank=True, null=True)
    weight = models.FloatField(default=10.0, verbose_name="Вес", blank=True, null=True)
    rating = models.FloatField(default=4.5, verbose_name="Рейтинг", blank=True, null=True)
...
class Order(models.Model):
    ...
    delivery_date = models.IntegerField(verbose_name="Дата доставки", blank=True, null=True)
